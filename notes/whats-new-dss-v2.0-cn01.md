...
#### This stage:
https://docs.oasis-open.org/dss-x/whats-new-dss/v2.0/cn01/whats-new-dss-v2.0-cn01.md (Authoritative) \
https://docs.oasis-open.org/dss-x/whats-new-dss/v2.0/cn01/whats-new-dss-v2.0-cn01.html \
https://docs.oasis-open.org/dss-x/whats-new-dss/v2.0/cn01/whats-new-dss-v2.0-cn01.pdf

#### Previous stage:
N/A

#### Latest stage:
https://docs.oasis-open.org/dss-x/whats-new-dss/v2.0/whats-new-dss-v2.0.md (Authoritative) \
https://docs.oasis-open.org/dss-x/whats-new-dss/v2.0/whats-new-dss-v2.0.html \
https://docs.oasis-open.org/dss-x/whats-new-dss/v2.0/whats-new-dss-v2.0.pdf
...
TC members should send comments on this document to the TC's email list. Others should send comments to the TC's public comment list, after subscribing to it by following the instructions at the "Send A Comment" button on the TC's web page at https://www.oasis-open.org/committees/dss-x/.
